export const esTranslations = {
  ...
  'home.recognition.dropzone':
    'Suelta un archivo de audio/video aquí para identificar la música',
  ...
  // Footer
  'footer.description':
    'AREA es una plataforma de automatización que te permite conectar tus servicios favoritos.',
  ...
  'landing.hero.subtitle':
    'Automatiza tus tareas diarias conectando tus servicios favoritos',
  ...
  'landing.features.automation.description':
    'Crea automatizaciones en pocos clics para ahorrar tiempo en tus tareas diarias.',
  'landing.features.services.title': 'Servicios Conectados',
  'landing.features.services.description':
    'Integra fácilmente tus servicios favoritos como Spotify, Discord y más.',
  ...
  'services.subtitle':
    'Conecta tus servicios favoritos para automatizar tus tareas',
  'services.github.description':
    'Accede a tus repositorios y gestiona proyectos GitHub',
