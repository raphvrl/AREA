export const itTranslations = {
  ...
  'home.recognition.dropzone':
    'Trascina qui un file audio/video per identificare la musica',
  ...
  'home.subtitle_welcome':
    'Gestisci le tue integrazioni e automatizza le tue attività',
  ...
  // Footer
  'footer.description':
    'AREA è una piattaforma di automazione che ti permette di connettere i tuoi servizi preferiti.',
  ...
  'landing.hero.subtitle':
    'Automatizza le tue attività quotidiane connettendo i tuoi servizi preferiti',
  ...
  'landing.features.automation.description':
    'Crea automazioni in pochi clic per risparmiare tempo nelle tue attività quotidiane.',
  'landing.features.services.title': 'Servizi Connessi',
  'landing.features.services.description':
    'Integra facilmente i tuoi servizi preferiti come Spotify, Discord e altri.',
  ...
  'services.subtitle':
    'Connetti i tuoi servizi preferiti per automatizzare le attività',
  'services.github.description':
    'Accedi ai tuoi repository e gestisci i progetti GitHub',
  'services.spotify.description':
    'Controlla la tua musica e gestisci le playlist',
  'services.linkedin.description':
    'Gestisci la tua rete professionale e le connessioni',
