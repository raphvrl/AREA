export const enTranslations = {
  ...
  'home.recognition.dropzone':
    'Drop an audio/video file here to identify the music',
  ...
  // Footer
  'footer.description':
    'AREA is an automation platform that lets you connect your favorite services.',
  ...
  'landing.features.automation.description':
    'Create automations in just a few clicks to save time on your daily tasks.',
  'landing.features.services.title': 'Connected Services',
  'landing.features.services.description':
    'Easily integrate your favorite services like Spotify, Discord, and more.',
  ...
  'services.github.description':
    'Access your repositories and manage GitHub projects',
